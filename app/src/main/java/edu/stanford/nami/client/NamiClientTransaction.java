...
@Flogger
public final class NamiClientTransaction implements ClientTransaction {
  ...
  public static NamiClientTransaction begin(NamiClient namiClient, Optional<Long> snapshotTid) {
    ...
    return new NamiClientTransaction(namiClient, snapshotId);
  }
}
